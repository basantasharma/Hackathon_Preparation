...
class User extends \Core\Model
{
    ...
    protected function sendPasswordResetEmail()
    {
        ...
        Mail::send($this->email, $this->name, 'Support', 'Password reset', $text, $html);
    }
    ...
    public function sendActivationEmail()
    {
        ...
        Mail::send($this->email, $this->name, 'Support', 'Account activation', $text, $html);
    }
    ...
    {
        $sql = 'SELECT name, id, email, gender, image, catogery, dob FROM users WHERE name LIKE :search OR email LIKE :search';
